const tiles = [
  ...
  { name: "Oriental Avenue", price: 100, rent: 6, color: "light-blue" },
  { name: "Chance", price: 0, rent: 0 },
  { name: "Vermont Avenue", price: 100, rent: 6, color: "light-blue" },
  { name: "Connecticut Avenue", price: 120, rent: 8, color: "light-blue" },
  ...
  { name: "Chance", price: 0, rent: 0 },
  { name: "Park Place", price: 350, rent: 35, color: "dark-blue" },
  { name: "Luxury Tax", price: 0, rent: 0 },
  { name: "Boardwalk", price: 400, rent: 50, color: "dark-blue" },
];
